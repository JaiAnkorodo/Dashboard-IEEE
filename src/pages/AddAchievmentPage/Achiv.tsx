...
const AchievmentPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    Swal.fire('Success', 'Achievment has been added!', 'success').then(() => {
      navigate('/achievment');
    });
  };
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            placeholder="Enter achievment title"
          />
        </div>
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            className="w-full p-2 border border-gray-300 rounded-lg dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            placeholder="Enter achievment description"
            rows={4}
          ></textarea>
        </div>
